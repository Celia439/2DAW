...
# a partir de ahora hacer más funciones para más legiviidad
# Salida esperada:
...
# Vocales: a=6, e=8, i=5, o=4, u=2 intenta implementar el reduce (mete parametros a las fucniones)
vocales={"a":0,"e":0,"i":0,"o":0,"u":0}
for i in texto.split():
    if i==" ":
        print(i) 

# Top 3 palabras más largas: programación, increíble, lenguaje(mayor de 8 caracteres) ordenar por la longitud de la palabra