        ...
        <div class="col-md-6">
            ...
            <fieldset class="p-5">
                ...
                <div class="mb-3">
                    ...
                    <input id="segundoApell" class="form-control" name="segundoApellido" placeholder="Segundo apellido"
                        type="text" placeholder="Segundo apellido" pattern="^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$" required />
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="nIdentidad" name="nIdentidad" type="text" placeholder="12345678A"
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" id="nSoporteDocumento" name="nSoporteDocumento" placeholder="ABC1234567"
                ...
                <input class="form-control" id="parentescoEntreViajeros" name="parentescoEntreViajeros" type="text"
                    placeholder="Parentesco entre viajeros" />
        ...
        <div class="col-md-6">
            <fieldset class="p-5">
                ...
                <div class="mb-3">
                    ...
                    <input id="codigoP" class="form-control" name="codigoP" type="text" placeholder="Codigo postal"
