            ...
            <fieldset>
                ...
                <div class="row g-3 p-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nombre_e" name="nombre" value="<?= htmlspecialchars($cliente['nombre']) ?>" required pattern="^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$" maxlength="50" placeholder="Ej: María">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="primer_apellido_e" name="primer_apellido" value="<?= htmlspecialchars($cliente['primer_apellido']) ?>" required pattern="^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$" maxlength="50" placeholder="Ej: García">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="segundo_apellido_e" name="segundo_apellido" value="<?= htmlspecialchars($cliente['segundo_apellido']) ?>" required pattern="^[A-Za-zÁÉÍÓÚáéíóúÑñ\s]+$" maxlength="50" placeholder="Ej: López">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="numero_documento_identidad_e" name="numero_documento_identidad" value="<?= htmlspecialchars($cliente['numero_documento_identidad']) ?>" required pattern="^[0-9]{8}[A-Z]$" placeholder="Ej: 12345678A">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="numero_soporte_documento_e" name="numero_soporte_documento" value="<?= htmlspecialchars($cliente['numero_soporte_documento']) ?>" required maxlength="20" placeholder="Ej: ABC123456">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="telefono_fijo_e" name="telefono_fijo" value="<?= htmlspecialchars($cliente['telefono_fijo']) ?>" pattern="^[0-9]{9}$" placeholder="Ej: 912345678">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="telefono_movil_e" name="telefono_movil" value="<?= htmlspecialchars($cliente['telefono_movil']) ?>" required pattern="^[0-9]{9}$" placeholder="Ej: 612345678">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="email" class="form-control" id="correo_e" name="correo" value="<?= htmlspecialchars($cliente['correo']) ?>" required placeholder="Ej: cliente@email.com">
            ...
            <fieldset>
                ...
                <div class="row g-3 p-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="direccion_e" name="direccion" value="<?= htmlspecialchars($cliente['direccion']) ?>" required maxlength="100" placeholder="Ej: Calle Mayor, 15">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="codigo_postal_e" name="codigo_postal" value="<?= htmlspecialchars($cliente['codigo_postal']) ?>" required pattern="^[0-9]{5}$" placeholder="Ej: 28001">
